...
\makeboxedtitle{No countable basis for Borel digraphs of dichromatic number at least three}{
    ...
    I prove that the Borel directed graphs admitting a Borel $2$-dicolouring form a $\mathbf\Sigma^1_2$-complete set; equivalently, that the set of Borel digraphs with Borel dichromatic number at least~$3$ is $\mathbf\Pi^1_2$-complete.
