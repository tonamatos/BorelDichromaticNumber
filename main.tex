...
We work throughout with \emph{nice codes} in the sense of Thornton~\cite{thornton2022algebraic, thornton-thesis}; see Section~\ref{sec:framework} for a brief review.
...
We remark that 2-dicoloring of directed graphs is \emph{not} a CSP in the sense of Thornton's algebraic framework~\cite{thornton2022algebraic}, since acyclicity is not a constraint expressible as a homomorphism to a fixed finite template; thus Proposition~\ref{prop:main} does not follow directly from Thornton's general results.
...
Now we recall the reduction from 2-coloring of 3-uniform hypergraphs to 2-dicoloring of directed graphs.
...
The reduction is due to Bokal et al.~\cite{Bokal_2004_CircularChrom}; we present it in a form convenient for the Borel lifting.
...
We now verify that the construction of Section~\ref{sec:classical} lifts to the Borel setting.
...
\subsection{The construction is \texorpdfstring{$\Delta^1_1$}{delta-one-one} in the codes}
