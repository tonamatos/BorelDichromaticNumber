...
\medskip
\begin{block}{Basic fact for finite graphs; proved in KST '99 in the Borel setting}
Every graph of degree $\leq d$ admits a $(d+1)$-coloring.
\end{block}
\end{frame}
...
\quad\Longleftrightarrow\quad
\exists\, e_c \in \mathcal N\; \bigl[\underbrace{\text{``$\mathcal{D}_{e_c}$ is a $k$-coloring of $G$''}}_{\Pi^1_1 \text{ in } e_c, e_G}\bigr]
$$
\end{block}
...
\begin{center}
	...
	\bigskip
	\large
	\texttt{\href{https://arxiv.org/abs/2604.05228}{arXiv/2604.05228}}
\end{center}
\end{frame}
